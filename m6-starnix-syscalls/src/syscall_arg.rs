// Forked from Fuchsia's starnix_syscalls, adapted for no_std (core::fmt).
// Original: Copyright 2023 The Fuchsia Authors. BSD license.
//
// Full upstream conversion set: the SyscallArg ↔ uapi user-pointer/value/flag
// conversions that the syscall dispatch relies on.
...
/// A raw syscall argument (u64 wrapper).
...
impl core::fmt::LowerHex for SyscallArg {
