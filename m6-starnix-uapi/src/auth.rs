// Forked from Fuchsia's starnix_uapi, adapted for M6 (no_std).
...
impl Capabilities {
    ...
    pub fn from_abi_v3(u32s: (u32, u32)) -> Self {
        Self {
            mask: u32s.0 as u64 | ((u32s.1 as u64) << 32),
        }
    }
}

impl core::convert::TryFrom<u64> for Capabilities {
    type Error = Errno;
...
impl core::fmt::LowerHex for Capabilities {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> Result<(), core::fmt::Error> {
        core::fmt::LowerHex::fmt(&self.mask, f)
    }
}
...
pub const CAP_CHOWN: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_CHOWN,
};
pub const CAP_DAC_OVERRIDE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_DAC_OVERRIDE,
};
pub const CAP_DAC_READ_SEARCH: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_DAC_READ_SEARCH,
};
pub const CAP_FOWNER: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_FOWNER,
};
pub const CAP_FSETID: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_FSETID,
};
pub const CAP_KILL: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_KILL,
};
pub const CAP_SETGID: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SETGID,
};
pub const CAP_SETUID: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SETUID,
};
pub const CAP_SETPCAP: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SETPCAP,
};
pub const CAP_LINUX_IMMUTABLE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_LINUX_IMMUTABLE,
};
pub const CAP_NET_BIND_SERVICE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_NET_BIND_SERVICE,
};
pub const CAP_NET_BROADCAST: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_NET_BROADCAST,
};
pub const CAP_NET_ADMIN: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_NET_ADMIN,
};
pub const CAP_NET_RAW: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_NET_RAW,
};
pub const CAP_IPC_LOCK: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_IPC_LOCK,
};
pub const CAP_IPC_OWNER: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_IPC_OWNER,
};
pub const CAP_SYS_MODULE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_MODULE,
};
pub const CAP_SYS_RAWIO: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_RAWIO,
};
pub const CAP_SYS_CHROOT: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_CHROOT,
};
pub const CAP_SYS_PTRACE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_PTRACE,
};
pub const CAP_SYS_PACCT: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_PACCT,
};
pub const CAP_SYS_ADMIN: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_ADMIN,
};
pub const CAP_SYS_BOOT: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_BOOT,
};
pub const CAP_SYS_NICE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_NICE,
};
pub const CAP_SYS_RESOURCE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_RESOURCE,
};
pub const CAP_SYS_TIME: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_TIME,
};
pub const CAP_SYS_TTY_CONFIG: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYS_TTY_CONFIG,
};
pub const CAP_MKNOD: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_MKNOD,
};
pub const CAP_LEASE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_LEASE,
};
pub const CAP_AUDIT_WRITE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_AUDIT_WRITE,
};
pub const CAP_AUDIT_CONTROL: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_AUDIT_CONTROL,
};
pub const CAP_SETFCAP: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SETFCAP,
};
pub const CAP_MAC_OVERRIDE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_MAC_OVERRIDE,
};
pub const CAP_MAC_ADMIN: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_MAC_ADMIN,
};
pub const CAP_SYSLOG: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_SYSLOG,
};
pub const CAP_WAKE_ALARM: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_WAKE_ALARM,
};
pub const CAP_BLOCK_SUSPEND: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_BLOCK_SUSPEND,
};
pub const CAP_AUDIT_READ: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_AUDIT_READ,
};
pub const CAP_PERFMON: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_PERFMON,
};
pub const CAP_BPF: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_BPF,
};
pub const CAP_CHECKPOINT_RESTORE: Capabilities = Capabilities {
    mask: 1u64 << uapi::CAP_CHECKPOINT_RESTORE,
};
...
impl Credentials {
    ...
    pub fn root() -> Arc<Self> {
        // M6: upstream caches this in a `LazyLock` static. We construct a fresh `Arc` each call
        // because `LazyLock` is not available in `no_std`; `Credentials` is immutable here so the
        // semantics are unchanged.
        Arc::new(Credentials::with_ids(0, 0))
    }
    ...
    pub fn exec(&mut self, maybe_set: UserAndOrGroupId) {
        ...
        //   P'(ambient)     = (file is privileged) ? 0 : P(ambient)
        self.cap_ambient = if file_is_privileged {
            Capabilities::empty()
        } else {
            self.cap_ambient
        };
        ...
        //   P'(effective)   = F(effective) ? P'(permitted) : P'(ambient)
        self.cap_effective = if file_effective {
            self.cap_permitted
        } else {
            self.cap_ambient
        };
