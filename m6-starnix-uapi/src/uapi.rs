...
// This file re-exports constants from linux_uapi and provides handwritten
// constants that are not generated from C headers.
...
pub const AF_QIPCRTR: uapi::__kernel_sa_family_t = 42;
