...
// M6: upstream uses `std::collections::HashMap`; in `no_std` we use `BTreeMap`, which requires
// `Resource: Ord` (added to the derive below).
...
pub struct ResourceLimits {
    values: BTreeMap<Resource, rlimit>,
}
