...
#[cfg(feature = "fuchsia")]
use crate::fs::sysfs::build_power_directory;
#[cfg(feature = "fuchsia")]
use crate::fs::sysfs::build_cpu_class_directory;
use crate::fs::sysfs::build_kernel_directory;
...
// Mirrors `ebpf_api::BPF_PROG_TYPE_FUSE` (gated eBPF crate); inlined so the
// /sys/fs/fuse sysfs surface stays intact without pulling in the eBPF API.
const BPF_PROG_TYPE_FUSE: u32 = 0x77777777;
