...
const UCONTEXT_RESERVED_DATA_SIZE: usize =
    max_const(m6_starnix_std::mem::size_of::<uapi::ucontext>(), m6_starnix_std::mem::size_of::<uapi::arch32::ucontext>());
...
pub const SIG_STACK_SIZE: usize = m6_starnix_std::mem::size_of::<SignalStackFrame>();
    ...
    match extended_pstate {
        ArchExtendedPstateStorage::State64(extended_pstate) => {
            ...
            let fpsimd = fpsimd_context {
                head: _aarch64_ctx {
                    magic: FPSIMD_MAGIC,
                    size: m6_starnix_std::mem::size_of::<fpsimd_context>() as u32,
                },
...
fn parse_pstate_extended_data(
    ...
    const FPSIMD_CONTEXT_SIZE: u32 = m6_starnix_std::mem::size_of::<fpsimd_context>() as u32;
    const ESR_CONTEXT_SIZE: u32 = m6_starnix_std::mem::size_of::<esr_context>() as u32;
            ...
            loop {
                match _aarch64_ctx::read_from_prefix(&data[offset..]) {
                    ...
                    Ok((_aarch64_ctx { magic: EXTRA_MAGIC, size }, _)) => {
                        if size as usize <= m6_starnix_std::mem::size_of::<_aarch64_ctx>() {
