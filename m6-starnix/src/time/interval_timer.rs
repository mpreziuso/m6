...
impl IntervalTimer {
        ...
        current_task.kernel().kthreads.spawn_future(
            move || async move {
                let _ = {
                    ...
                    // Unfortunately, m6_starnix_std::mem::drop is not working correctly on this:
    ...
    pub fn time_remaining(&self) -> TimerRemaining {
        ...
        TimerRemaining {
            remainder: m6_starnix_std::cmp::max(
...
impl PartialEq for IntervalTimer {
    fn eq(&self, other: &Self) -> bool {
        m6_starnix_std::ptr::addr_of!(self) == m6_starnix_std::ptr::addr_of!(other)
    }
}
