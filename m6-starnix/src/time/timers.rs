...
static_assertions::const_assert!(
    m6_starnix_std::mem::size_of::<uapi::__kernel_timer_t>()
        == m6_starnix_std::mem::size_of::<uapi::arch32::__kernel_timer_t>()
);
pub type TimerId = uapi::__kernel_timer_t;

static_assertions::const_assert!(
    m6_starnix_std::mem::size_of::<uapi::__kernel_clockid_t>()
        == m6_starnix_std::mem::size_of::<uapi::arch32::__kernel_clockid_t>()
);
