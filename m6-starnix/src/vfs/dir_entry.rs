...
use m6_starnix_std::collections::btree_map::Entry;
...
impl DirEntry {
        ...
        L: LockEqualOrBefore<FileOpsCore>,
    {
        ...
        m6_starnix_std::mem::drop(self_children);
    ...
    pub fn is_descendant_of(self: &DirEntryHandle, other: &DirEntryHandle) -> bool {
        ...
        loop {
            if m6_starnix_std::ptr::eq(current, other.deref()) {
                // We found |other|.
                return true;
            }
    ...
    pub fn remove_child(&self, name: &FsStr, mounts: &Mounts) {
        ...
        if let Some(child) = child {
            ...
            m6_starnix_std::mem::drop(children);
    ...
    fn internal_remove_child(&self, child: &DirEntry) {
        ...
        if let Some(weak_child) = children.get(local_name) {
            ...
            if m6_starnix_std::ptr::eq(weak_child.as_ptr(), child) {
