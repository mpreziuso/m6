...
use m6_starnix_std::num::NonZero;
...
fn run_generic_netlink_worker_internal<S: Sender<GenericMessage>>(
    params: GenericNetlinkWorkerParams<S>,
) -> impl m6_starnix_std::future::Future<Output = ()> + Send {
...
mod tests {
    ...
    struct TestFamily {
        ...
        multicast_message_sinks: RcuHashMap<
            ...
            m6_starnix_std::collections::hash_map::RandomState,
        >,
    }
        ...
        fn default() -> Self {
            Self {
                ...
                multicast_message_sinks: RcuHashMap::with_hasher(
                    m6_starnix_std::collections::hash_map::RandomState::new(),
                ),
            }
        }
    }
