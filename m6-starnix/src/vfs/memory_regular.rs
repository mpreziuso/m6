...
use crate::mm_ref::{PAGE_SIZE, ProtectionFlags, VMEX_RESOURCE};
use crate::security;
...
macro_rules! fileops_impl_memory {
    ($self:ident, $memory:expr) => {
        ...
        fn get_memory(
            ...
            prot: $crate::mm_ref::ProtectionFlags,
        ) -> Result<Arc<$crate::mm_ref::memory::MemoryObject>, starnix_uapi::errors::Errno> {
