...
use crate::mm_ref::{IOVecPtr, MemoryAccessorExt, PAGE_SIZE};
...
fn copy_data(
    ...
    let mut copy = || -> Result<(), Errno> {
        while remaining > 0 {
            ...
            let chunk_length = m6_starnix_std::cmp::min(*PAGE_SIZE as usize, remaining);
...
pub fn sendfile(
    ...
    let length = m6_starnix_std::cmp::min(count as usize, MAX_RW_COUNT);
...
pub fn copy_file_range(
    ...
    let length = m6_starnix_std::cmp::min(length, MAX_RW_COUNT);
