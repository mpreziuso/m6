...
// Socket-backed io_uring opcodes (Send/Recv/SendMsg/RecvMsg) are gated with the
// socket subsystem; those opcodes fall through to EOPNOTSUPP in the minimal core.
#[cfg(feature = "fuchsia")]
...
static_assertions::const_assert_eq!(
    m6_starnix_std::mem::size_of::<u16>(),
    uapi::size_of_field!(UserRingBufferHeader, tail)
);
static_assertions::const_assert_eq!(
    m6_starnix_std::mem::size_of::<UserRingBufferHeader>(),
    m6_starnix_std::mem::size_of::<UserRingBufferEntry>()
);
...
static_assertions::const_assert_eq!(m6_starnix_std::mem::size_of::<ControlHeader>(), RING_ALIGNMENT);
...
static_assertions::const_assert_eq!(
    m6_starnix_std::mem::offset_of!(CqEntry, user_data),
    m6_starnix_std::mem::offset_of!(io_uring_cqe, user_data)
);
static_assertions::const_assert_eq!(
    m6_starnix_std::mem::offset_of!(CqEntry, res),
    m6_starnix_std::mem::offset_of!(io_uring_cqe, res)
);
static_assertions::const_assert_eq!(
    m6_starnix_std::mem::offset_of!(CqEntry, flags),
    m6_starnix_std::mem::offset_of!(io_uring_cqe, flags)
);

const CQES_OFFSET: usize = m6_starnix_std::mem::size_of::<ControlHeader>();
...
impl IoUringMetadata {
    ...
    fn cq_entry_offset(&self, index: u32) -> u64 {
        ...
        (CQES_OFFSET + index as usize * m6_starnix_std::mem::size_of::<io_uring_cqe>()) as u64
    }
    ...
    fn array_offset(&self) -> usize {
        CQES_OFFSET
            + align_ring_field(self.cq_entries as usize * m6_starnix_std::mem::size_of::<io_uring_cqe>())
    }
    ...
    fn array_entry_offset(&self, index: u32) -> u64 {
        ...
        (self.array_offset() + index as usize * m6_starnix_std::mem::size_of::<RingIndex>()) as u64
    }

    /// The number of bytes in the `ring_buffer` VMO.
    fn ring_buffer_size(&self) -> usize {
        self.array_offset() + self.sq_entries as usize * m6_starnix_std::mem::size_of::<RingIndex>()
    }
    ...
    fn sq_entry_offset(&self, index: u32) -> u64 {
        let index = index % self.sq_entries;
        (index as usize * m6_starnix_std::mem::size_of::<io_uring_sqe>()) as u64
    }

    /// The number of bytes in the `sq_entries` VMO.
    fn sq_entries_size(&self) -> usize {
        self.sq_entries as usize * m6_starnix_std::mem::size_of::<io_uring_sqe>()
    }
}
...
impl IoUringQueue {
    ...
    fn read_sq_head(&self) -> Result<u32, Errno> {
        read_object(&self.ring_buffer, m6_starnix_std::mem::offset_of!(ControlHeader, sq_head) as u64)
    }

    fn write_sq_head(&self, value: u32) -> Result<(), Errno> {
        write_object(&self.ring_buffer, m6_starnix_std::mem::offset_of!(ControlHeader, sq_head) as u64, &value)
    }
    ...
    fn read_sq_tail(&self) -> Result<u32, Errno> {
        ...
        read_object(&self.ring_buffer, m6_starnix_std::mem::offset_of!(ControlHeader, sq_tail) as u64)
    }
    ...
    fn read_cq_head(&self) -> Result<u32, Errno> {
        ...
        // acquire once we map these buffers into kernel memory.
        read_object(&self.ring_buffer, m6_starnix_std::mem::offset_of!(ControlHeader, cq_head) as u64)
    }

    fn read_cq_tail(&self) -> Result<u32, Errno> {
        read_object(&self.ring_buffer, m6_starnix_std::mem::offset_of!(ControlHeader, cq_tail) as u64)
    }
    ...
    fn write_cq_tail(&self, value: u32) -> Result<(), Errno> {
        ...
        write_object(&self.ring_buffer, m6_starnix_std::mem::offset_of!(ControlHeader, cq_tail) as u64, &value)
    }
    ...
    fn increment_overflow(&self) -> Result<(), Errno> {
        ...
        // operation.
        let offset = m6_starnix_std::mem::offset_of!(ControlHeader, cq_overflow) as u64;
...
impl IoUringFileObject {
        ...
        L: LockEqualOrBefore<FileOpsCore>,
    {
        ...
        params.sq_off = io_sqring_offsets {
            head: m6_starnix_std::mem::offset_of!(ControlHeader, sq_head) as u32,
            tail: m6_starnix_std::mem::offset_of!(ControlHeader, sq_tail) as u32,
            ring_mask: m6_starnix_std::mem::offset_of!(ControlHeader, sq_ring_mask) as u32,
            ring_entries: m6_starnix_std::mem::offset_of!(ControlHeader, sq_ring_entries) as u32,
            flags: m6_starnix_std::mem::offset_of!(ControlHeader, sq_flags) as u32,
            dropped: m6_starnix_std::mem::offset_of!(ControlHeader, sq_dropped) as u32,
            array: queue.metadata.array_offset() as u32,
            ..Default::default()
        };
        params.cq_off = io_cqring_offsets {
            head: m6_starnix_std::mem::offset_of!(ControlHeader, cq_head) as u32,
            tail: m6_starnix_std::mem::offset_of!(ControlHeader, cq_tail) as u32,
            ring_mask: m6_starnix_std::mem::offset_of!(ControlHeader, cq_ring_mask) as u32,
            ring_entries: m6_starnix_std::mem::offset_of!(ControlHeader, cq_ring_entries) as u32,
            overflow: m6_starnix_std::mem::offset_of!(ControlHeader, cq_overflow) as u32,
            cqes: queue.metadata.cqes_offset() as u32,
            flags: m6_starnix_std::mem::offset_of!(ControlHeader, cq_flags) as u32,
            ..Default::default()
        };
        ...
        match Op::from_code(entry.opcode as io_uring_op)? {
            ...
            Op::RecvMsg => {
                ...
                let (mut msg_hdr_ref, recv_msg_buffer_info): (
                    ...
                    // - msghdr.msg_control
                    // - payload
                    let headerlen: u32 = m6_starnix_std::mem::size_of::<uapi::io_uring_recvmsg_out>() as u32;
...
impl IoUringProviderRingBuffer {
    fn new(config: uapi::io_uring_buf_reg) -> Result<Self, Errno> {
        ...
        let tail_ptr =
            UserRef::<u16>::from((ring_addr + m6_starnix_std::mem::offset_of!(UserRingBufferHeader, tail))?);
