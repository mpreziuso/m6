...
use crate::task::{CurrentTask, EventHandler, KernelOrTask, WaitCanceler, Waiter};
#[cfg(feature = "fuchsia")]
use crate::task::{LogSubscription, Syslog, SyslogAccess};
...
enum LogOutputTag<'a> {
    Str(&'a str),
    Display(&'a dyn m6_starnix_std::fmt::Display),
}
