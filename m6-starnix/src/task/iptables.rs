...
use bstr::BString;
// REMOVED(fidl) use fidl_fuchsia_net_filter_ext::sync::Controller;
// REMOVED(fidl) use fidl_fuchsia_net_filter_ext::{
...
use m6_starnix_std::ops::{Deref as _, Index, IndexMut};
        ...
        match optname {
            ...
            IPT_SO_GET_ENTRIES => {
                if socket.domain == SocketDomain::Inet {
                    ...
                    optval.truncate(m6_starnix_std::mem::size_of::<ipt_get_entries>());
                    ...
                    optval.truncate(m6_starnix_std::mem::size_of::<ip6t_get_entries>());
                    optval.append(&mut entry_bytes);
                }
                Ok(optval)
            }
    ...
    pub fn setsockopt(
        ...
        match optname {
            ...
            IPT_SO_SET_ADD_COUNTERS => {
                ...
                bytes = bytes.split_off(m6_starnix_std::mem::size_of::<xt_counters_info>());
                for chunk in bytes.chunks(m6_starnix_std::mem::size_of::<xt_counters>()) {
                    counters
