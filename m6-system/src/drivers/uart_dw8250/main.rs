...
//!
//! Userspace driver for Synopsys DesignWare 8250 UART, commonly found on
//! Rockchip RK3588 (Rock 5B+) and similar SoCs.
...
/// Entry point for DesignWare 8250 UART driver.
///
/// # Safety
///
...
pub unsafe extern "C" fn _start() -> ! {
    ...
    // Create DW8250 driver instance
    // SAFETY: We just mapped the device frame to this address
    let uart = unsafe { Dw8250::new(UART_MMIO_VADDR as usize) };
    uart.init();
...
#[allow(dead_code)]
fn handle_irq(uart: &Dw8250, rx_buffer: &mut RxBuffer) {
...
fn service_loop(uart: &Dw8250, irq_enabled: bool) -> ! {
...
fn handle_write_inline(uart: &Dw8250, x0: u64, msg: &[u64; 4]) -> u64 {
...
fn handle_read(uart: &Dw8250, rx_buffer: &mut RxBuffer) -> u64 {
...
fn handle_get_status(uart: &Dw8250, rx_buffer: &RxBuffer) -> u64 {
    let mut flags = 0u64;
    if uart.tx_ready() {
